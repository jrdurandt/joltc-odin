...
JOLTC_SHARED :: #config(JOLTC_SHARED, false)

when ODIN_OS == .Windows {
	when JOLTC_SHARED {
		foreign import lib "joltc.lib"
	} else {
		foreign import lib {"joltc/build/lib/Distribution/joltc.lib", "joltc/build/lib/Distribution/Jolt.lib"}
	}
	...
	when JOLTC_SHARED {
		...
		foreign import lib {"joltc/build/lib/libjoltc.a", "joltc/build/lib/libJolt.a"}
	}
}
...
TireMaxImpulseCallback :: proc "c" (
	userData: rawptr,
	wheelIndex: u32,
	outLongitudinalImpulse: ^f32,
	outLateralImpulse: ^f32,
...
foreign lib {
	...
	PhysicsSystem_DrawBodies :: proc(system: ^PhysicsSystem,
		settings: ^DrawSettings,
		renderer: ^DebugRenderer,
		bodyFilter: ^BodyDrawFilter, /* = nullptr */) ---
...
foreign lib {
	...
	TaperedCylinderShapeSettings_Create :: proc(halfHeightOfTaperedCylinder: f32,
		topRadius: f32,
		bottomRadius: f32,
		convexRadius: f32, /* = cDefaultConvexRadius*/
		material: ^PhysicsMaterial, /* = NULL*/) -> ^TaperedCylinderShapeSettings ---
	...
	MutableCompoundShape_AddShape :: proc(shape: ^MutableCompoundShape,
		position: ^Vec3,
		rotation: ^Quat,
		child: ^Shape,
		userData: u32, /* = 0 */
		index: u32, /* = UINT32_MAX */) -> u32 ---
...
foreign lib {
	...
	Character_AddToPhysicsSystem :: proc(character: ^Character,
		activationMode: Activation, /*= JPH_ActivationActivate */
		lockBodies: bool, /* = true */) ---
	Character_RemoveFromPhysicsSystem :: proc(character: ^Character,
		lockBodies: bool, /* = true */) ---
	Character_Activate :: proc(character: ^Character,
		lockBodies: bool, /* = true */) ---
	Character_PostSimulation :: proc(character: ^Character,
		maxSeparationDistance: f32,
		lockBodies: bool, /* = true */) ---
	Character_SetLinearAndAngularVelocity :: proc(character: ^Character,
		linearVelocity: ^Vec3,
		angularVelocity: ^Vec3,
		lockBodies: bool, /* = true */) ---
	Character_GetLinearVelocity :: proc(character: ^Character, result: ^Vec3) ---
	Character_SetLinearVelocity :: proc(character: ^Character,
		value: ^Vec3,
		lockBodies: bool, /* = true */) ---
	Character_AddLinearVelocity :: proc(character: ^Character,
		value: ^Vec3,
		lockBodies: bool, /* = true */) ---
	Character_AddImpulse :: proc(character: ^Character,
		value: ^Vec3,
		lockBodies: bool, /* = true */) ---
	Character_GetBodyID :: proc(character: ^Character) -> BodyID ---
	Character_GetPositionAndRotation :: proc(character: ^Character,
		position: ^RVec3,
		rotation: ^Quat,
		lockBodies: bool, /* = true */) ---
	Character_SetPositionAndRotation :: proc(character: ^Character,
		position: ^RVec3,
		rotation: ^Quat,
		activationMode: Activation,
		lockBodies: bool, /* = true */) ---
	Character_GetPosition :: proc(character: ^Character,
		position: ^RVec3,
		lockBodies: bool, /* = true */) ---
	Character_SetPosition :: proc(character: ^Character,
		position: ^RVec3,
		activationMode: Activation,
		lockBodies: bool, /* = true */) ---
	Character_GetRotation :: proc(character: ^Character,
		rotation: ^Quat,
		lockBodies: bool, /* = true */) ---
	Character_SetRotation :: proc(character: ^Character,
		rotation: ^Quat,
		activationMode: Activation,
		lockBodies: bool, /* = true */) ---
	Character_GetCenterOfMassPosition :: proc(character: ^Character,
		result: ^RVec3,
		lockBodies: bool, /* = true */) ---
	Character_GetWorldTransform :: proc(character: ^Character,
		result: ^RMat4,
		lockBodies: bool, /* = true */) ---
	Character_GetLayer :: proc(character: ^Character) -> ObjectLayer ---
	Character_SetLayer :: proc(character: ^Character,
		value: ObjectLayer,
		lockBodies: bool, /*= true*/) ---
	Character_SetShape :: proc(character: ^Character,
		shape: ^Shape,
		maxPenetrationDepth: f32,
		lockBodies: bool, /*= true*/) ---
...
foreign lib {
	...
	RagdollSettings_DisableParentChildCollisions :: proc(settings: ^RagdollSettings,
		jointMatrices: ^Mat4, /*=nullptr*/
		minSeparationDistance: f32, /* = 0.0f*/) ---
	...
	RagdollSettings_CreateRagdoll :: proc(settings: ^RagdollSettings,
		system: ^PhysicsSystem,
		collisionGroup: CollisionGroupID, /*=0*/
		userData: u64, /* = 0*/) -> ^Ragdoll ---

	/* Ragdoll */
	Ragdoll_Destroy :: proc(ragdoll: ^Ragdoll) ---
	Ragdoll_AddToPhysicsSystem :: proc(ragdoll: ^Ragdoll,
		activationMode: Activation, /*= JPH_ActivationActivate */
		lockBodies: bool, /* = true */) ---
	Ragdoll_RemoveFromPhysicsSystem :: proc(ragdoll: ^Ragdoll,
		lockBodies: bool, /* = true */) ---
	Ragdoll_Activate :: proc(ragdoll: ^Ragdoll,
		lockBodies: bool, /* = true */) ---
	Ragdoll_IsActive :: proc(ragdoll: ^Ragdoll,
		lockBodies: bool, /* = true */) -> bool ---
	Ragdoll_ResetWarmStart :: proc(ragdoll: ^Ragdoll) ---
	Ragdoll_SetPose :: proc(ragdoll: ^Ragdoll,
		pose: ^SkeletonPose,
		lockBodies: bool, /* = true */) ---
	Ragdoll_SetPose2 :: proc(ragdoll: ^Ragdoll,
		rootOffset: ^RVec3,
		jointMatrices: ^Mat4,
		lockBodies: bool, /* = true */) ---
	Ragdoll_GetPose :: proc(ragdoll: ^Ragdoll,
		outPose: ^SkeletonPose,
		lockBodies: bool, /* = true */) ---
	Ragdoll_GetPose2 :: proc(ragdoll: ^Ragdoll,
		outRootOffset: ^RVec3,
		outJointMatrices: ^Mat4,
		lockBodies: bool, /* = true */) ---
	Ragdoll_DriveToPoseUsingMotors :: proc(ragdoll: ^Ragdoll, pose: ^SkeletonPose) ---
	Ragdoll_DriveToPoseUsingKinematics :: proc(ragdoll: ^Ragdoll,
		pose: ^SkeletonPose,
		deltaTime: f32,
		lockBodies: bool, /* = true */) ---
	...
	Ragdoll_GetRootTransform :: proc(ragdoll: ^Ragdoll,
		outPosition: ^RVec3,
		outRotation: ^Quat,
		lockBodies: bool, /* = true */) ---
